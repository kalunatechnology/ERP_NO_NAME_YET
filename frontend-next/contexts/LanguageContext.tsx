...
const idToEnglish: Record<string, string> = {
  ...
  "Distribusi Proyek": "Project Distribution",
  "Kesehatan Portofolio": "Portfolio Health",
  "Sesuai Target": "On-track",
  "Sesuai Jadwal": "On-track",
  "Perlu Perhatian": "Caution",
  "Role Ditugaskan": "Assigned Roles",
  "Role Aktif": "Active Role",
  "Izin Modul": "Module permissions",
  "Default Role": "Role default",
  "Tidak Ada Akses": "No access",
  "Hanya Lihat": "View only",
  "Lihat & Kelola": "View & manage",
  "Tugas Utama": "Main Task",
  "Rencana Mingguan": "Weekly Plan",
  "Supervisor Proyek": "Project Supervisor",
  "Utilisasi Anggaran": "Budget Utilization",
  "Anggaran": "Budget",
  "Biaya": "Cost",
  "Pendapatan": "Revenue",
  "Keuntungan": "Profit",
  ...
  "Opsional, isi bila ada lembur": "Optional, fill in if overtime",
  "Alasan Lembur": "Overtime Reason",
  "Bukti penyelesaian lembur": "Overtime completion proof",
  "Bukti Lembur": "Overtime Proof",
  "Tanggal kerja": "Work date",
...
// Additional explicit aliases where English term maps to standard Indonesian
Object.assign(englishToId, {
  "Executive Summary": "Ringkasan Eksekutif",
  "Completion Rate": "Tingkat Penyelesaian",
  "Project Distribution": "Distribusi Proyek",
  "Portfolio Health": "Kesehatan Portofolio",
  "On-track": "Sesuai Target",
  "Caution": "Perlu Perhatian",
  "Off-track": "Terlambat",
  "Assigned Roles": "Role Ditugaskan",
  "Active Role": "Role Aktif",
  "Module permissions": "Izin Modul",
  "Role default": "Default Role",
  "No access": "Tidak Ada Akses",
  "View only": "Hanya Lihat",
  "View & manage": "Lihat & Kelola",
  "Main Task": "Tugas Utama",
  "Weekly Plan": "Rencana Mingguan",
  "Daily Task": "Tugas Harian",
  "Assigned Projects": "Proyek Ditugaskan",
  ...
  "List": "Daftar",
  "All": "Semua",
  "Project Supervisor": "Supervisor Proyek",
  "Budget Utilization by Project": "Utilisasi Anggaran per Proyek",
  "Balance Status": "Status Saldo",
  "Unavailable": "Belum Tersedia",
  "awaiting approval": "menunggu persetujuan",
  "pending approval": "menunggu persetujuan",
  "Governance Dashboard": "Dashboard Tata Kelola",
  "Company & Access": "Perusahaan & Akses",
  "Global Reports": "Laporan Global",
  "Company Dashboard": "Dashboard Perusahaan",
  "User & Access": "Pengguna & Akses",
  "Executive Dashboard": "Dashboard Eksekutif",
  "All Projects": "Semua Proyek",
  "Finance Preview": "Pratinjau Keuangan",
  "CRM Preview": "Pratinjau CRM",
  "Performance": "Kinerja",
  "Management Reports": "Laporan Manajemen",
  "Projects": "Proyek",
  "Finance": "Keuangan",
