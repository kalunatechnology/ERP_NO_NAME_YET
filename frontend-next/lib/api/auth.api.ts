...
export const DEMO_PROFILES: UserProfile[] = [
  /* ── 8 Akun Resmi PT Sinergi Muda Arsa (@arsalynk.com) ── */
  {
    ...
    active_role_code: "ROLE-DIRECTOR",
    roles: [{ role: "DIRECTOR", role_code: "ROLE-DIRECTOR", role_name: "Director", company_id: "10000000-0000-0000-0000-000000000001" }],
  },
  {
    ...
    active_role_code: "ROLE-PM",
    roles: [
      { role: "PROJECT_MANAGER", role_code: "ROLE-PM", role_name: "Lead Project Manager", company_id: "10000000-0000-0000-0000-000000000001" },
      { role: "OPERATIONAL_MANAGER", role_code: "ROLE-OM", role_name: "Operational Manager", company_id: "10000000-0000-0000-0000-000000000001" },
    ],
  },
  {
    ...
    active_role_code: "ROLE-OM",
    roles: [
      { role: "OPERATIONAL_MANAGER", role_code: "ROLE-OM", role_name: "Operational Manager", company_id: "10000000-0000-0000-0000-000000000001" },
      { role: "SUPERVISOR", role_code: "ROLE-SUPERVISOR", role_name: "Supervisor", company_id: "10000000-0000-0000-0000-000000000001" },
    ],
  },
  {
    ...
    active_role_code: "ROLE-PM",
    roles: [
      { role: "PROJECT_MANAGER", role_code: "ROLE-PM", role_name: "Lead Project Manager & Riset", company_id: "10000000-0000-0000-0000-000000000001" },
      { role: "FINANCE", role_code: "ROLE-FINANCE", role_name: "Finance", company_id: "10000000-0000-0000-0000-000000000001" },
    ],
  },
  {
  ...
  },
  {
    ...
    active_role_code: "ROLE-COMPANY-ADMIN",
    roles: [
      { role: "COMPANY_ADMIN", role_code: "ROLE-COMPANY-ADMIN", role_name: "Company Administrator", company_id: "10000000-0000-0000-0000-000000000001" },
      { role: "SUPERVISOR", role_code: "ROLE-SUPERVISOR", role_name: "Field Specialist / Engineer", company_id: "10000000-0000-0000-0000-000000000001" },
      { role: "STAFF", role_code: "ROLE-STAFF", role_name: "Staff", company_id: "10000000-0000-0000-0000-000000000001" },
    ],
  },
  {
  ...
  /* ── 10 Ghost Demo Personas ── */
  {
    ...
    is_superuser: false,
    is_staff: false,
    roles: [{ role: "COMPANY_ADMIN", role_code: "ROLE-COMPANY-ADMIN", role_name: "Ghost Company Administrator" }],
  },
  {
